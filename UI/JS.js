...
ATA.Communication = {
	...
	Allowed_Evals:{},
	Eval:function(oName, oData){
		if (this.Allowed_Evals[oName]) this.Allowed_Evals[oName](oData);
		else console.log("NOT DEFINED FUNCTION => ", oName, oData);
	},
};
...
ATA.Setups.push(function(){
	...
	ATA.EvalInCore(function(){
		ATA.EvalInUI(function(){
			console.log("The console in ui by " +  ATA.Settings.ID);
		});
